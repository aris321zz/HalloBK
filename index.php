...
<body>
    <div class="gradient">
        <div id="Kotak_login" class="container mt-5 bg-light rounded-4 shadow-lg" style="width: 400px;">
            ...
            <h2 class="tulisan_login text-center">Login</h2>
            ...
            <form method="post">
                ...
                <a href="register.php" style="color: blue; text-align:center; padding: 25px;">Belum Punya Akun ? </a>
                <a href="login_admin.php" style="color: blue; text-align:center;"> Login Sebagai Admin</a>
                <br />
                <br />
            </form>
        </div>
