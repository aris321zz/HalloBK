            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Tabel Data Admin</h4><a href="tambah_admin.php">Tambah
                                    Admin</a>
                                <div class="data-tables">
                                    <table id="dataTable" class="text-center">
                                        ...
                                        <tbody>
                                            <?php
                                            include 'function.php';
                                            $data = mysqli_query($conn, "SELECT * FROM admin ORDER BY username ASC");
                                            ...
                                            <tr>
                                                ...
                                                <?php echo "<td><a href='edit_admin.php?id_admin=$id'>Edit</a></td>"; ?>
                                                <?php echo "<td><a class='btn btn-danger' style='width: 100px; margin-left: 44%; ' href='hapus_admin.php?id_admin=$id'>Hapus</a></td>"; ?>
                                                <td></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
