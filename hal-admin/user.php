                                ...
                                <div class="data-tables">
                                    <table id="dataTable" class="text-center">
                                        ...
                                        <tbody>
                                            ...
                                            $data = mysqli_query($conn, "SELECT * FROM user ORDER BY username ASC");
                                            ...
                                            <tr>
                                                ...
                                                <?php echo "<td><a href='edit_user.php?id_user=$id'>Edit</a></td>"; ?>
                                                <?php echo "<td><a class='btn btn-danger' style='width: 100px; margin-left: 44%; ' href='hapus.php?id_user=$id'>Hapus</a></td>"; ?>
                                                <td></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
