...
$id = $_GET['id_konsul'];
$query = "SELECT * FROM tb_konsul WHERE id_konsul = '$id'";
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="row">
                            <div class="container mt-5 p-5 bg-secondary-25 rounded-4 shadow-lg" style="width: 400px;">
                                <form action="update.php" method="POST">
                                    <tr>
                                        <h2>Balasan</h2>
                                        <td>
                                            <input type="hidden" name="id_konsul" value="<?php echo $id; ?>">
                                            <?php echo $konsul; ?>
                                            <textarea type="text" name="balasan"
                                                class="form-control border border-info mb-3" rows="4"
                                                value="<?php echo $balas; ?>">
                                            </textarea>
                                        </td>
